...
At any point you can click the following icon to switch between light and dark mode: 
...
Press any course on the calendar to add review information for that course instance:
